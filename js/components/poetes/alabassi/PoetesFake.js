...
poetes :[
{
  'Nom' : ' أبو فراس الحمداني'   ,
   ...
   'Historique' :'
   هو الحارث بن سعيد بن حمدان الحمداني، يرجع أصله إلى قبيلة تغلب، ولد عام 320 هـ، قُتل أبوه وهو في الثالثة من عمره، وبهذا، تربّى أبو فراس على يد أمّه وبرعايه ابن عمّه سيف الدولة الحمداني، الذي حالما أصبح حاكماً لحلب، اصطحبه معه ل0حترف الأدب والفروسيّة والعلم.'
   'poeme' :[
     {
       'Titre' :'aaa',
       'contenu' :'aaaaa'

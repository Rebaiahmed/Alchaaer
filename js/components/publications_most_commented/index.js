...
class PublicationsCommented extends Component {
  ...
  const { props: { name, index, list } } = this;
    ...
    return (
      ...
      <Header>
            ...
            <Body>
              <Title>{(name) ? this.props.name : 'ألأكثر تعليقا  '}</Title>
            </Body>
    ...
    <Footer >
                 ...
                 <Button onPress={() => Actions.publications()}>
                 <Icon name="apps" />
                     <Text>الاكثر اعجابا </Text>
                 </Button>
                 <Button active onPress={() => Actions.publications_commented()}>
                 <Icon name="apps" />
...
export default connect(mapStateToProps, bindAction)(PublicationsCommented);

...
class PoetsAlabassiPage extends Component {
  ...
  render() {
    ...
    return (
      ...
      <Header>
        ...
        <Body>
          <Title>{(name) ? this.props.name : 'العباسيون  '}</Title>
        </Body>
...
export default connect(mapStateToProps, bindAction)(PoetsAlabassiPage);

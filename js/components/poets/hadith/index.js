...
import { Container, Header, Title, Content, Icon, Left, Right,Card, CardItem, Text, Body,
List, ListItem,Thumbnail,InputGroup, Input ,Picker,Badge,H3, Fab,Item,
...
class PoetsAlhadithPage extends Component {
...
addFavorites()
{
  ...
  render() {
   ...
   <List>
                        ...
                        <ListItem rounded>
                            <Thumbnail square size={80} source={require('../../../../images/poetes/alhadith/ibrahimtou9an.jpg')} />
                            <Body>
                        <Text>
                        يعتبر بدر شاكر السيّاب
           ...
           <Text note>
                        ...
                        <ListItem outline>
                            <Thumbnail square size={80} source={require('../../../../images/poetes/alhadith/ahmechaw9i.jpeg')} />
                            <Body>
                            <Text>
                            يعتبر الشّاعر المصريّ أحمد شوقي من أشهر الشّعراء العرب وقد لُقب بأمير الشّعراء
    </Text>
    <Text note>
      إقرأ المزيد
    </Text>
                 ...
                 onPress={()=>{
                   ...
                   setTimeout(() => {
                     Share.open(shareOptions)
                            ...
                            <Footer>
                                                <FooterTab>
                                                    <Button  onPress={this.addFavorites.bind(this)}>
                                                        <Icon name="bookmark" />
                                                    </Button>
...
export default connect(mapStateToProps, bindAction)(PoetsAlhadithPage);

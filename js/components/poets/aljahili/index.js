...
class PoetsAlajahiliPage extends Component {
  ...
  render() {
    ...
    return (
      ...
      <Header>
        ...
        <Body>
          <Title>{(name) ? this.props.name : 'شعراء المُعلّقات  '}</Title>
        </Body>
...
export default connect(mapStateToProps, bindAction)(PoetsAlajahiliPage);

...
class FollowerssPage extends Component {
...
FollowerssPage  = Animatable.createAnimatableComponent(FollowerssPage );
export default connect(mapStateToProps, bindAction)(FollowerssPage);
